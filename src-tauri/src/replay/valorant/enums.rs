...
impl EAresAttributeIndex {
    ...
    pub fn from_index(index: u32) -> Option<EAresAttributeIndex> {
        ...
        const TABLE: [EAresAttributeIndex; 142] = [
            ...
            CanSeeOthersHealth,
            DamageReduction,
            DefensiveDetectionDuration,
            DescendingGravityModifier,
            DetectionDelay,
            DetectionDisabled,
            EquippableMovementModifier,
            HealingEffectiveness,
            ShieldRestoreEffectiveness,
            FiringErrorModifier,
            FiringRateModifier,
            StabilityMovementModifier,
            GravityModifier,
            FootstepVolumeReduction,
            ForceCrouch,
            Frozen,
            ...
            JumpMovementSlow,
            MinimapBlinded,
            MinimumAboveMaxSpeedDecayRateReduction,
            FallDamageReduction,
            LockMovement,
            MagazineBonus,
            MapVisibleToAll,
            ...
            MaxTurnRate,
            MinError,
            MinimapDetectionDelay,
            MinimapDisabled,
            MinimapInvisible,
            MinimapViewDistance,
            MaxVisionDistance,
            MoneyKillRewardModifier,
            MovementBonus,
            MovementBonusCrouch,
            MovementBonusFlying,
            MovementBonusJump,
            MovementBonusRun,
            MovementBonusWalk,
            MovementErrorModifier,
            MovementSlow,
            OffensiveDetectionDuration,
            PickupAmmoBonus,
            PreventAbilities,
            PreventCrouch,
            ...
            PreventPickup,
            PrimarySlotDisabled,
            ReduceAbilityMovementPenalty,
            ReduceTaggingMovementPenalty,
            ReloadTimeModifier,
            SpreadRecoveryModifier,
            Stealthed,
            Untrackable,
            RecoilModifier,
            ThirdPerson,
            TurnRatePenalty,
            UltimatePointsDeathModifier,
            UltimatePointsDefuseModifier,
            UltimatePointsKillModifier,
            UltimatePointsPickUpModifier,
            UltimatePointsPlantModifier,
            UsingTimeModifier,
            WallPenetrationDistanceModifier,
            WeaponDrawTimeModifier,
            ...
            EquipmentDisabled,
            TemporaryDamage,
            IncomingDamageShieldPenetrationModifier,
            IncomingSelfDamageModifier,
            IncomingAllyDamageModifier,
            PreventDeathFromDamage,
            BlindImmune,
            PreventUsingAbilities,
            PreventUsingAscenders,
            PreventUsingLoreItems,
            OverrideEquippableBaseMovement,
            ...
            BombPlantTime,
            BombDefuseTime,
            FootstepPlayTimeMultiplier,
            HeadshotDamageMultiplier,
            NormalDamageMultiplier,
            LegshotDamageMultiplier,
        ];
