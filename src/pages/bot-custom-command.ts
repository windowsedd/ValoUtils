export const CUSTOM_COMMAND_WHENS = ["command", "onPregame", "onMatchStart", "onMatchEnd"] as const;
...
export const normalizeCustomBotCommand = (
  ...
  const normalized = {
    ...
    language:
      typeof value?.language === "string" && value.language.trim() ? value.language.trim() : "none",
