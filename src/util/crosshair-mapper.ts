import type {
  ...
  PrimarySettings,
  SniperSettings,
} from "@/components/crosshair-svg-generator";
...
function mapSniper(sniper: RiotSniperSettings): SniperSettings {
  const color = sniper.bUseCustomCenterDotColor
...
export function mapRiotCrosshairProfile(profile: RiotCrosshairProfile): CrosshairSettings {
  return {
    ...
    override_all_primary_crosshairs_with_my_primary_crosshair:
      !!profile.bUseCustomCrosshairOnAllPrimary,
